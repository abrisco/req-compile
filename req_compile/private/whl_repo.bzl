...
SDIST_ATTRS = {
    ...
    "_compiler": attr.label(
        allow_files = True,
        default = Label("//req_compile/private:sdist_compiler.py"),
    ),
}
...
load("@rules_req_compile//req_compile/private:utils.bzl", "whl_repo_name")
load("@rules_venv//python:defs.bzl", "py_library", "py_binary")
