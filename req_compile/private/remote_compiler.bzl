...
load("//req_compile/private:compiler.bzl", "PyReqsCompilerInfo")
...
def py_reqs_remote_compiler(name, compiler, platform = None, **kwargs):
    ...
    py_venv_binary(
        name = name + "_bin",
        srcs = [Label("//req_compile/private:remote_compiler.py")],
        main = Label("//req_compile/private:remote_compiler.py"),
        data = [
            compiler,
            name + "_args_file",
            name + "_solution_file",
    ...
    py_venv_binary(
        name = name,
        srcs = [Label("//req_compile/private:remote_orchestrator.py")],
        main = Label("//req_compile/private:remote_orchestrator.py"),
