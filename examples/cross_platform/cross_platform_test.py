...
class CrossPlatformZipTest(unittest.TestCase):
    ...
    def test_linux(self) -> None:
        self.python_zip_file_tester(
            ...
            expected=[
                ".*_linux__black/site-packages/black/__init__.py",
            ],
            illegal_prefixes=(
                ".*_platform_macos__",
                ".*_windows__",
    ...
    def test_macos(self) -> None:
        self.python_zip_file_tester(
            ...
            expected=[
                ".*_macos__black/site-packages/black/__init__.py",
            ],
            illegal_prefixes=(
                ".*_linux__",
                ".*_windows__",
    ...
    def test_windows(self) -> None:
        self.python_zip_file_tester(
            ...
            expected=[
                ".*_windows__black/site-packages/black/__init__.py",
                ".*_windows__colorama/site-packages/colorama/__init__.py",
            ],
            illegal_prefixes=(
                ".*_linux__",
                ".*_macos__",
