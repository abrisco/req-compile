...
class IntegrationTest(unittest.TestCase):
    ...
    def test_copy_annotations(self) -> None:
        ...
        expected = [
            "pip_deps_{}__numpy/site-packages/numpy/conftest.copy.py",
            "pip_deps_{}__numpy/site-packages/numpy-1.26.4.dist-info/entry_points.copy.txt",
            "pip_deps_{}__numpy/site-packages/numpy/testing/setup.copy.py",
        ]
